                ...
                <div class="p-6 text-black dark:text-black">
                    <form action="#" method="post">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                <label for="comboboxClase" class="block text-sm font-medium text-white">Selecciona una Clase</label>
                            ...
                            <div>
                                <label for="comboboxDocente" class="block text-sm font-medium text-white">Selecciona un docente</label>
