                        ...
                        <tbody>
                            @php $contador = 1; @endphp
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $claseP->nombre_clase }}</td>
                                    <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $claseP->nombre }} {{ $claseP->apellido }}</td>
