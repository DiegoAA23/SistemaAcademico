        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @foreach ($list as $item)
                ...
                <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/5 mb-4 p-2">
                    <a href="#" class="block w-full bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 p-2">
                        <h5 class="mb-2 text-lg font-bold text-gray-900"><strong>{{ $item->nombre_clase }}</strong></h5>
                        <p class="font-normal text-gray-700"><strong>Horario:</strong> {{ $item->hora_inicio }}</p>
