                ...
                <div class="mb-4">
                    ...
                    <table class="table-auto w-full">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $profesore->id_profesor }}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $profesore->nombre }}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $profesore->apellido }}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $profesore->especialidad->especialidad }}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $profesore->correo_electronico }}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $profesore->telefono }}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $profesore->estado->descripcion }}</td>
                    
                                <td class="border px-4 py-2 text-center">
                                    <div class="flex justify-center">
                                        <a href="{{ route('profesorEdit', $profesore->id_profesor) }}" class="bg-cyan-900 dark:bg-cyan-900 hover:bg-indigo-600 dark:hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded mr-2">Editar</a>
                                        <button type="button" class="bg-gray-700 dark:bg-gray-700 hover:bg-red-600 dark:hover:bg-red-900 text-white font-bold py-2 px-4 rounded" onclick="confirmDelete('{{ $profesore->id_profesor }}')">Inhabilitar</button>
                                    </div> 
                                </td>
                            </tr>
                            @endforeach
