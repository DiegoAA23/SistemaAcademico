                ...
                <div class="mb-4">
                    ...
                    <table class="table-auto w-full">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $horario->id_horario}}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $horario->clase->nombre_clase}}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $horario->aula->aula}}</td>

                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $horario->dias }}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $horario->fecha_inicio }}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $horario->fecha_fin }}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $horario->hora_inicio }}</td>
                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $horario->hora_fin }}</td>

                                <td class="border px-4 py-2 text-gray-900 dark:text-white text-center">{{ $horario->estado->descripcion}}</td>

                                <td class="border px-4 py-2 text-center">
                                    <div class="flex justify-center">
                                        <a href="{{ route('horarioEdit', $horario->id_horario) }}" class="bg-cyan-900 dark:bg-cyan-900 hover:bg-indigo-600 dark:hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded mr-2">Editar</a>
                                        <button type="button" class="bg-gray-700 dark:bg-gray-700 hover:bg-red-600 dark:hover:bg-red-900 text-white font-bold py-2 px-4 rounded" onclick="confirmDelete('{{ $horario->id_horario }}')">Inhabilitar</button>
                                    </div> 
                                </td>
                            </tr>
                            @endforeach
